...
import { Building2, Code2, Mail, MessageSquare, Phone } from "@/components/icons";
  ...
  return (
    <InfoLayout>
      <span className="inline-flex items-center gap-1.5 text-[13px] font-medium tracking-tight text-primary">
        <span className="size-1.5 rounded-full bg-primary" /> Contact us
      </span>
      <h1 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">Get in touch</h1>
      <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground">
        Questions, feedback or partnership ideas? Reach the {APP_NAME} team at Setups Works —
      ...
      <section className="mt-10 grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">Best for support and detailed questions.</p>
          </div>
        </a>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">Mon–Sat, 10am–7pm IST.</p>
          </div>
        </a>
      </section>
      ...
      <section className="mt-4 flex items-start gap-4 rounded-2xl border bg-card p-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/feedback" className="font-medium text-primary hover:underline">feedback form</Link>{" "}
